# -*- coding: utf-8 -*-
# Parts of BrowseInfo. See LICENSE file for full copyright and licensing details.
...
class CustomFields(models.Model):
    ...
    after_which_field = fields.Many2one('ir.model.fields', string="After which Field", domain="[('model_id.id', '=',model_id)]")
