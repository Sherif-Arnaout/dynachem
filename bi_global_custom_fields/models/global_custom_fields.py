# -*- coding: utf-8 -*-
# Part of BrowseInfo. See LICENSE file for full copyright and licensing details test.
...
class IrModelsFieldsCustom(models.Model):
    ...
    after_which_field = fields.Many2one('ir.model.fields', domain="[('model_id.id', '=',model_id)]")
